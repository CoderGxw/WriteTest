...
public class WrittenView extends View {
    ...
    public WrittenView(Context context) {
        super(context);
        init(context);
    }

    public WrittenView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public WrittenView(Context context, AttributeSet attrs, int defStyleAttr) {
